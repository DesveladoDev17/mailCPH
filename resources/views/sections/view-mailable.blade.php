                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ( empty($resource['data']->subject) )
                                        <td>
                                            <span class="text-muted">Sin conjunto de sujetos, Se utilizará el namespace predeterminado. Ver <a href="https://laravel.com/docs/9.x/notifications#customizing-the-subject">Personaliza el tema</a></span>
                                        </td>
                                    @else
                                        <td>
				    			...
				    			@endif
				    				...
				    				<tr>
	                                    <td class="table-fit font-weight-sixhundred">Para</td>
                                	...
                                	<tr>
	                                    <td class="table-fit font-weight-sixhundred">Responder a</td>
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-info send-test"><svg fill="#fff" width="20" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn btn-primary"
                                   href="{{ route('editMailable', ['name' => $resource['name']]) }}">Editar Template</a>
                            @endif
                        </div>
