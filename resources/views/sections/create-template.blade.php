                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-2">
                        <div class="card-header p-3" style="border-bottom:1px solid #e7e7e7e6;">
                            <button type="button" class="btn btn-primary float-right save-template">Crear</button>
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Texto plano</a>
                      </li>
                    </ul>
...
[endcomponent]: # 
            ...
            $('.save-template').click(function(){
                ...
                notie.input({
                  text: 'Escribir el nombre del template:',
                  type: 'text',
                  placeholder: 'e.j. Notificación',
                  submitText: 'Crear Nombre',
                  cancelText: 'Cancelar',
                  ...
                  text: 'Escribir la descripción template:',
                  type: 'text',
                  submitText: 'Crear Template',
                  cancelText: 'Cancelar',
                  allowed: new RegExp('[^a-zA-Z0-9 ]', 'g'),
            ...
            var plaintextEditor = CodeMirror.fromTextArea(document.getElementById("plain_text"), {
                lineNumbers: false,
                mode: 'plain/text',
                placeholder: "Versión de texto sin formato por correo electrónico (opcional)",
            });
