...
<div class="col-lg-12 col-md-12">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('mailableList') }}">Enviables</a></li>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="card mb-2">
                        <div class="card-header p-3" style="border-bottom:1px solid #e7e7e7e6;">
                            ...
                            <button type="button" class="btn btn-light mr-2 save-draft disabled">Guardar borrador</button>
...
$(document).ready(function(){
    ...
    $('.send-test').click(function(e){
        ...
        notie.input({
            text: 'Destinatario de correo electrónico de prueba:',
            type: 'text',
            placeholder: 'Email',
        ...
        axios.post('{{ route('sendTestMail') }}', {
            ...
            .then(function (response) {
                ...
                if (response.status === 200) {
                    notie.alert({type: 'success', text: 'Test email enviado', time: 4})
                } else {
...
[endcomponent]: #
    ...
    submitCallback: function () {
        ...
        localStorage.setItem(templateID, simplemde.codemirror.getValue());
        $('.save-draft').addClass('disabled').text('Borrador guardado');
