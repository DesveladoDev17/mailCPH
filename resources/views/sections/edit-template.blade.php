                    ...
                    <div id="accordion">
                      <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                          <div class="card-body">
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Nombre:</b> {{ ucfirst($template['name']) }}</p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Slug:</b> {{ $template['slug'] }}</p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Descripción:</b> {{ $template['description'] }}</p>
                            
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template View:</b> {{ 'maileclipse::templates.'.$template['slug'] }}</p>

                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template tipo:</b> {{ ucfirst($template['template_type']) }}</p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template nombre:</b> {{ ucfirst($template['template_view_name']) }}</p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Skeleton:</b> {{ ucfirst($template['template_skeleton']) }}</p>
                            <p class="text-primary edit-template" style="cursor:pointer;"><i class="fas fa-trash"></i> Edit Detalles</p>
                            <p class="text-danger delete-template" style="cursor:pointer;"><i class="fas fa-trash "></i> Eliminar Template</p>
                        </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="card mb-2">
                        <div class="card-header p-3" style="border-bottom:1px solid #e7e7e7e6;">
                            <button type="button" class="btn btn-success float-right save-template">Actualizar</button>
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Vista:</b> {{ 'maileclipse::templates.'.$template['slug'] }}</p>

                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Tipo:</b> {{ ucfirst($template['template_type']) }}</p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Nombre:</b> {{ ucfirst($template['template_view_name']) }}</p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template Skeleton:</b> {{ ucfirst($template['template_skeleton']) }}</p>
                            <p class="text-primary edit-template" style="cursor:pointer;"><i class="fas fa-trash"></i> Editar detalles</p>
                            <span class="text-danger delete-template" style="cursor:pointer;"><i class="fas fa-trash "></i> Eliminar Template</p>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function(){
	 ...
	 $('.edit-template').click(function(){
		...
		notie.input({
                  text: 'Nuevo nombre template:',
                  type: 'text',
				  submitText: 'Actualizar Nombre',
                  cancelText: 'Cancelar',
                  placeholder: 'e.j. Notificación',
                  allowed: new RegExp('[^a-zA-Z0-9 ]', 'g'),
                  submitCallback: function (templatename) {

                    notie.input({
                  text: 'NEW template descripción:',
                  type: 'text',
                  submitText: 'Actualizar Template',
                  cancelText: 'Cancelar',
                  allowed: new RegExp('[^a-zA-Z0-9 ]', 'g'),
	...
	$('.delete-template').click(function(){
		...
		notie.confirm({
	        ...
	        text: 'Estás seguro de que quieres hacer eso?',
			submitText: 'Si',
            cancelText: 'Cancelar',
		    ...
		    .then(function (response) {
		    	...
		    	if (response.data.status == 'ok'){
		    		...
		    		notie.alert({ type: 1, text: 'Template eliminado <br><small>Redireccionando...</small>', time: 3 })
...
[endcomponent]: # 
	...
	$('.save-template').click(function(){
		 ...
		 notie.confirm({
	        ...
	        text: 'Estás segura de que quieres hacer eso?',
			submitText: 'Si',
            cancelText: 'Cancelar',
		    ...
		    .then(function (response) {
		    	...
		    	if (response.data.status == 'ok'){
		    		...
		    		notie.alert({ type: 1, text: 'Template actualizado', time: 3 })

				    localStorage.removeItem(templateID);
			    } else {
			    	
			    	notie.alert({ type: 'error', text: 'Template no actualizado', time: 3 })
			    }
